...
Public Class Reporte_GuiaSsenda
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApp1.Reporte_GuiaSsenda.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NROGUIA() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporte_GuiaSsenda
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_GuiaSsenda = New Reporte_GuiaSsenda()
        rpt.Site = Me.Site
        Return rpt
    End Function
