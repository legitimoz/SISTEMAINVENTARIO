...
Public Class Reporte_GuiaNordic
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApp1.Reporte_GuiaNordic.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_GuiaNordic
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_GuiaNordic = New Reporte_GuiaNordic()
        rpt.Site = Me.Site
        Return rpt
    End Function
