...
Public Class Reporte_RutaNordic
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApp1.Reporte_RutaNordic.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CRG_ID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporte_RutaNordic
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_RutaNordic = New Reporte_RutaNordic()
        rpt.Site = Me.Site
        Return rpt
    End Function
