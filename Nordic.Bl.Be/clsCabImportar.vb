...
Public Class clsCabImportar

    Private _listaItem As List(Of clsImportDetalle)
    Public Property prListaItem() As List(Of clsImportDetalle)
        Get
            Return _listaItem
        End Get
        Set(ByVal value As List(Of clsImportDetalle))
            _listaItem = value
        End Set
    End Property
    ...
    Public Function Serializar_Importar(ByVal _clsCabImportar As clsCabImportar) As String
    ...
    Public Sub RegistrarImportacion(ByVal _xmlserializado As String, ByRef _tiporespuesta As String, ByRef _textorespuesta As String, ByRef idRentabilidad As String, ByRef fecHoraReg As String)
        Try
            ...
            Using oSqlConnectionMedlab As SqlConnection = New SqlConnection(Conexion)
                Using oSqlCommandMedlab As SqlCommand = New SqlCommand("DSN_REGISTRAR_IMPORTAR_ARCHIVO", oSqlConnectionMedlab)
